...
import net.ivnogood.maythings.network.CrusherguiButtonMessage;
...
public class CrusherguiScreen extends AbstractContainerScreen<CrusherguiMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("coolthings:textures/crushergui.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Crusher", 70, 5, -16777216);
		this.font.draw(poseStack, "Cost 5xp", 66, 67, -16711936);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 61, this.topPos + 41, 50, 20, new TextComponent("crush"), e -> {
			if (true) {
				CoolthingsMod.PACKET_HANDLER.sendToServer(new CrusherguiButtonMessage(0, x, y, z));
