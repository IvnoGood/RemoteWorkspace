...
public class GunbulletBlock extends Block {
	public GunbulletBlock() {
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(CoolthingsModBlocks.GUNBULLET.get(), renderType -> renderType == RenderType.cutout());
	}
}
