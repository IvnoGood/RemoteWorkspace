...
import net.ivnogood.maythings.procedures.Cropform4UpdateTickProcedure;
...
public class Cropform4Block extends Block {
	public Cropform4Block() {
	...
	public void tick(BlockState blockstate, ServerLevel world, BlockPos pos, Random random) {
		...
		Cropform4UpdateTickProcedure.execute(world, x, y, z);
		world.scheduleTick(pos, this, 1000);
	}
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(CoolthingsModBlocks.CROPFORM_4.get(), renderType -> renderType == RenderType.cutout());
	}
