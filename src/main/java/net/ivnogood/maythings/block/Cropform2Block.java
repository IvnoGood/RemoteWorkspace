...
import net.ivnogood.maythings.procedures.Cropform2UpdateTickProcedure;
...
public class Cropform2Block extends Block {
	public Cropform2Block() {
	...
	public void tick(BlockState blockstate, ServerLevel world, BlockPos pos, Random random) {
		...
		Cropform2UpdateTickProcedure.execute(world, x, y, z);
		world.scheduleTick(pos, this, 1000);
	}
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(CoolthingsModBlocks.CROPFORM_2.get(), renderType -> renderType == RenderType.cutout());
	}
