...
import net.ivnogood.maythings.world.teleporter.UltimatedimensionTeleporter;
import net.ivnogood.maythings.world.teleporter.UltimatedimensionPortalShape;

import java.util.Random;
import java.util.Optional;

public class UltimatedimensionPortalBlock extends NetherPortalBlock {
	public UltimatedimensionPortalBlock() {
	...
	public static void portalSpawn(Level world, BlockPos pos) {
		Optional<UltimatedimensionPortalShape> optional = UltimatedimensionPortalShape.findEmptyPortalShape(world, pos, Direction.Axis.X);
	...
	public BlockState updateShape(BlockState p_54928_, Direction p_54929_, BlockState p_54930_, LevelAccessor p_54931_, BlockPos p_54932_,
		...
		return !flag && !p_54930_.is(this) && !(new UltimatedimensionPortalShape(p_54931_, p_54932_, direction$axis1)).isComplete()
	...
	public void animateTick(BlockState state, Level world, BlockPos pos, Random random) {
		...
		if (random.nextInt(110) == 0)
			world.playSound(null, pos.getX() + 0.5, pos.getY() + 0.5, pos.getZ() + 0.5,
					ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation(("block.anvil.use"))), SoundSource.BLOCKS, 0.5f,
		...
		if (!entity.isPassenger() && !entity.isVehicle() && entity.canChangeDimensions() && !entity.level.isClientSide() && true) {
			if (entity.isOnPortalCooldown()) {
				entity.setPortalCooldown();
					...
					new ResourceLocation("coolthings:ultimatedimension"))) {
				entity.setPortalCooldown();
	...
	private void teleportToDimension(Entity entity, BlockPos pos, ResourceKey<Level> destinationType) {
		entity.changeDimension(entity.getServer().getLevel(destinationType),
				new UltimatedimensionTeleporter(entity.getServer().getLevel(destinationType), pos));
	}
}
