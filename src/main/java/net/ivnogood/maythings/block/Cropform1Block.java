...
import net.ivnogood.maythings.procedures.Cropform1UpdateTickProcedure;
...
public class Cropform1Block extends Block {
	public Cropform1Block() {
	...
	public void tick(BlockState blockstate, ServerLevel world, BlockPos pos, Random random) {
		...
		Cropform1UpdateTickProcedure.execute(world, x, y, z);
		world.scheduleTick(pos, this, 1000);
	}
	...
	public static void registerRenderLayer() {
		ItemBlockRenderTypes.setRenderLayer(CoolthingsModBlocks.CROPFORM_1.get(), renderType -> renderType == RenderType.cutout());
	}
