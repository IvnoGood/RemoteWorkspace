...
import net.ivnogood.maythings.procedures.CrusherbuttonProcedure;
...
public class CrusherguiButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			CrusherbuttonProcedure.execute(world, x, y, z, entity);
		}
	}

	@SubscribeEvent
	public static void registerMessage(FMLCommonSetupEvent event) {
		CoolthingsMod.addNetworkMessage(CrusherguiButtonMessage.class, CrusherguiButtonMessage::buffer, CrusherguiButtonMessage::new,
				CrusherguiButtonMessage::handler);
	}
}
